...
class TrajectoryDataset(Dataset):
    ...
    def __init__(
        ...
        all_files = [os.path.join(self.data_dir, _path) for _path in all_files] # Lists all files in the dataset directory and constructs their full paths.
        num_peds_in_seq = []
        seq_list = []
        seq_list_rel = []
        loss_mask_list = []
        ...
        for path in all_files:
            ...
            for idx in range(0, num_sequences * self.skip + 1, skip):
                ...
                for _, ped_id in enumerate(peds_in_curr_seq):
                    if ped_id == most_frequent_ped_id:
                        continue
